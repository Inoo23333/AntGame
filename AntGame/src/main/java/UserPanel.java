...
public class UserPanel {
    ...
    public static void start(float incTime, int antVelocity, int antNum, float[] initAntPositions, int stickLength)
    {
    ...
    public static void main(String[] args) {
        //setInformations();
        start(incTime,antVelocity,antNum,initAntPositions,stickLength);
        AntGameFrame ge = new AntGameFrame(incTime,antNum,CreepingGame.arrayList);////////要改数据来源
        ge.ShowAnt(minTime,maxTime);
    }
